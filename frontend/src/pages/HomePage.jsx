...
export function HomePage() {
  ...
  return (
    <div className="flex flex-col items-center w-full h-full lg:max-w-screen-lg mx-auto xl:max-w-screen-xl 2xl:max-w-screen-2xl 3xl:max-w-screen-3xl overflow-hidden bg-neutral-100 dark:bg-zinc-800 dark:text-zinc-50">
      <header className="font-sans text-left p-6 py-15 relative rounded-3xl w-full lg:w-1/2">
        ...
        <div className="relative flex items-center mt-8">
          <input
            ...
            className="px-4 py-2 w-full text-gray-500 text-center bg-neutral-100 dark:bg-zinc-600 dark:text-zinc-50 dark:placeholder:text-zinc-50 rounded-2xl focous:outline-none "
          />
          <span className="absolute inset-y-0 left-3 flex items-center stroke-zinc-900 stroke-5">
            {svgs.search({ className: 'dark:stroke-zinc-50' })}
          </span>
        </div>
